...
Feedback is welcome - please open an issue on the plugin's [GitHub repository](https://github.com/christianwach/civicrm-admin-utilities) if you find any bugs or have suggestions for improvements.
...
* Introduce "Wellow Brook" RiverLea Stream as a replacement for the Radstock Theme
* Style fixes for the CiviCRM Menu in recent versions of WordPress
