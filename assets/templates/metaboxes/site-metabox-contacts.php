...
<table class="form-table">
	...
	<tr>
		...
		<td>
			...
			<label class="civicrm_admin_utilities_settings_label" for="civicrm_admin_utilities_email_suppress"><?php _e( 'Suppress the email to the WordPress user.', 'civicrm-admin-utilities' ); ?></label>
	...
	<tr>
		...
		<td>
			...
			<label class="civicrm_admin_utilities_settings_label" for="civicrm_admin_utilities_fix_soft_delete"><?php _e( 'Fix the Contact "soft delete" process.', 'civicrm-admin-utilities' ); ?></label>
